class Api::V1::TrashLoggersController < ApplicationController
  ...
  def trash_logger_params
    params.require(:trash_logger).permit( :describe_trash, :describe_location, :adjacent_waterway, :phone_id, :latitude, :longitude, :county, :date_observed, upload_images_attributes: [:image] )
  end
